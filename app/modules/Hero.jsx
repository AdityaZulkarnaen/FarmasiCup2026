...
const Hero = () => {
  return (
    <div className='bg-[#422351] h-screen flex items-center justify-center overflow-x-clip'>
        ...
        <Image src={fasi} width={420} alt="Fasi" className='absolute top-25 left-10 z-999 rotate-345 drop-shadow-[0_0_25px_rgba(255,255,255,0.7)] max-lg:h-auto max-lg:w-[260px] max-lg:top-24 max-lg:left-2 max-sm:w-[140px] max-sm:top-50 max-sm:rotate-30 max-sm:left-0' />
        <Image src={Title} alt="Title" className='flex z-999 scale-40 max-lg:scale-[28%] max-sm:scale-[80%]' />
